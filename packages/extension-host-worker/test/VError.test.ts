...
test('VError - merging stacks', () => {
  ...
  at getProtocol (http://localhost:3000/packages/renderer-worker/src/parts/FileSystem/FileSystem.ts:18:29)
  at Module.copy (http://localhost:3000/packages/renderer-worker/src/parts/FileSystem/FileSystem.ts:110:20)
  at handleDropIntoFolder (http://localhost:3000/packages/renderer-worker/src/parts/ViewletExplorer/ViewletExplorerHandleDropIndex.ts:14:22)`
...
test('VError - merging stacks - parent stack does not include message', () => {
  ...
  error.stack = `  at exports.invoke (/test/packages/main-process/src/parts/Command/Command.ts:64:13)
  at async exports.getResponse (/test/packages/main-process/src/parts/GetResponse/GetResponse.ts:8:20)
  at async MessagePortMain.handleMessage (/test/packages/main-process/src/parts/HandleMessagePort/HandleMessagePort.ts:179:22)`
  ...
  expect(verror.stack).toBe(
    `  at exports.invoke (/test/packages/main-process/src/parts/Command/Command.ts:64:13)
  at async exports.getResponse (/test/packages/main-process/src/parts/GetResponse/GetResponse.ts:8:20)
  at async MessagePortMain.handleMessage (/test/packages/main-process/src/parts/HandleMessagePort/HandleMessagePort.ts:179:22)`,
  )
})
...
test('VError - remove unnecessary Error prefix', () => {
  const error = new Error()
  error.message = 'Failed to import script /test/extension.ts: Not found (404)'
  const verror = new VError(error, 'Failed to activate extension test.test-extension')
  expect(verror.message).toBe('Failed to activate extension test.test-extension: Failed to import script /test/extension.ts: Not found (404)')
})
