...
export const setSashes = (state, sashSideBar, sashPanel) => {
  ...
  SetBounds.setBounds($SashSideBar, sashSideBar.top, sashSideBar.left, sashSideBar.width, sashSideBar.height)
  SetBounds.setBounds($SashPanel, sashPanel.top, sashPanel.left, sashPanel.width, sashPanel.height)
}
