...
test('event - pointerup after pointerdown - on vertical scroll bar thumb', () => {
  ...
  expect(spy1).toHaveBeenNthCalledWith(1, 'pointermove', EditorEvents.handleScrollBarThumbVerticalPointerMove)
...
test('event - pointerup after pointerdown - on horizontal scroll bar thumb', () => {
  ...
  expect(spy1).toHaveBeenCalledTimes(2)
  expect(spy1).toHaveBeenNthCalledWith(1, 'pointermove', EditorEvents.handleScrollBarThumbHorizontalPointerMove)
