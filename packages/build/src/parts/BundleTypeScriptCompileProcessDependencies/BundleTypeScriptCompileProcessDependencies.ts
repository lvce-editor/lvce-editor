...
import * as FilterTypeScriptCompileProcessDependencies from '../FilterTypeScriptCompileProcessDependencies/FilterTypeScriptCompileProcessDependencies.ts'
...
export const bundleTypeScriptCompileProcessDependencies = async ({ to, exclude = [] as any[] }) => {
