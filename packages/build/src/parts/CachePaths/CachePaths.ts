...
const getRendererProcessCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/BundleRendererProcess/BundleRendererProcess.ts',
      'packages/build/src/parts/BundleRendererProcessCached/BundleRendererProcessCached.ts',
    ],
    extraContents,
  )
  return hash
...
const getMainProcessCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/CachePaths/CachePaths.ts',
      'packages/build/src/parts/BundleMainProcess/BundleMainProcess.ts',
      'packages/build/src/parts/BundleMainProcessCached/BundleMainProcessCached.ts',
      'packages/build/src/parts/BundleOptions/BundleOptions.ts',
    ],
    extraContents,
  )
  return hash
...
const getSharedProcessCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/BundleJsRollup/BundleJsRollup.ts',
      'packages/build/src/parts/CachePaths/CachePaths.ts',
      'packages/build/src/parts/BundleSharedProcess/BundleSharedProcess.ts',
      'packages/build/src/parts/BundleSharedProcessCached/BundleSharedProcessCached.ts',
...
const getTypeScriptCompileProcessCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/BundleJsRollup/BundleJsRollup.ts',
      'packages/build/src/parts/CachePaths/CachePaths.ts',
      'packages/build/src/parts/BundleTypeScriptCompileProcess/BundleTypeScriptCompileProcess.ts',
      'packages/build/src/parts/BundleTypeScriptCompileProcessCached/BundleTypeScriptCompileProcessCached.ts',
      'packages/build/src/parts/BundleTypeScriptCompileProcessDependencies/BundleTypeScriptCompileProcessDependencies.ts',
      'packages/build/src/parts/BundleOptions/BundleOptions.ts',
    ],
    extraContents,
  )
...
const getSearchProcessCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/BundleJsRollup/BundleJsRollup.ts',
      'packages/build/src/parts/CachePaths/CachePaths.ts',
      'packages/build/src/parts/BundleSearchProcess/BundleSearchProcess.ts',
      'packages/build/src/parts/BundleSearchProcessCached/BundleSearchProcessCached.ts',
      'packages/build/src/parts/BundleSearchProcessDependencies/BundleSearchProcessDependencies.ts',
      'packages/build/src/parts/BundleOptions/BundleOptions.ts',
    ],
    extraContents,
  )
...
const getProcessExplorerCacheHash = async (extraContents) => {
  const hash = await Hash.computeFolderHash(
    ...
    [
      ...
      'packages/build/src/parts/BundleJsRollup/BundleJsRollup.ts',
      'packages/build/src/parts/CachePaths/CachePaths.ts',
      'packages/build/src/parts/BundleProcessExplorer/BundleProcessExplorer.ts',
      'packages/build/src/parts/BundleProcessExplorerCached/BundleProcessExplorerCached.ts',
      'packages/build/src/parts/BundleProcessExplorerDependencies/BundleProcessExplorerDependencies.ts',
      'packages/build/src/parts/BundleOptions/BundleOptions.ts',
    ],
    extraContents,
  )
