import * as BundleFileSystemProcess from '../BundleFileSystemProcess/BundleFileSystemProcess.ts'
import * as CopyDependencies from '../CopyDependencies/CopyDependencies.ts'
import * as FilterSharedProcessDependencies from '../FilterSharedProcessDependencies/FilterSharedProcessDependencies.ts'
import * as JsonFile from '../JsonFile/JsonFile.ts'
import * as NpmDependencies from '../NpmDependencies/NpmDependencies.ts'
import * as Path from '../Path/Path.ts'
import * as Remove from '../Remove/Remove.ts'
import * as RemoveBarePrebuilds from '../RemoveBarePrebuilds/RemoveBarePrebuilds.ts'
import * as RemoveNodePtyFiles from '../RemoveNodePtyFiles/RemoveNodePtyFiles.ts'
import * as RemoveRipgrepFiles from '../RemoveRipgrepFiles/RemoveRipGrepFiles.ts'
import * as RemoveSourceMaps from '../RemoveSourceMaps/RemoveSourceMaps.ts'

export const bundleSharedProcessDependencies = async ({ to, arch, electronVersion, exclude = [] as any[], platform = process.platform }) => {
