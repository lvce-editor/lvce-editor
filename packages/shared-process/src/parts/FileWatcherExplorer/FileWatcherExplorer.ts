import * as LaunchFileWatcherExplorer from '../LaunchFileWatcherExplorer/LaunchFileWatcherExplorer.ts'
...
export const getOrCreate = async (): Promise<any> => {
  if (!state.ipc) {
    state.ipc = LaunchFileWatcherExplorer.launchFileWatcherExplorer()
  }
  return state.ipc
}
