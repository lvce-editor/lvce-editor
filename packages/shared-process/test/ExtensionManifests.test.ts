...
jest.unstable_mockModule('../src/parts/ExtensionManifests/ExtensionManifestsFromFolder.js', () => ({
...
const ExtensionManifestsFromFolder = await import('../src/parts/ExtensionManifests/ExtensionManifestsFromFolder.js')
