...
const ExtensionHostColorTheme = await import('../src/parts/ExtensionManagement/ExtensionManagementColorTheme.js')
...
test.skip('getColorThemeJson - theme id contains number', async () => {
  ...
  const colorThemePath = join(tmpDir, 'builtin.theme-cobalt2', 'color-theme.json')
