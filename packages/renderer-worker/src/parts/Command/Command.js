...
const MODULE_EDITOR_COMMAND_APPLY_EDIT = 85
const MODULE_EDITOR_COMMAND_BLUR = 86
const MODULE_EDITOR_COMMAND_BRACE_COMPLETION = 87
const MODULE_EDITOR_COMMAND_CANCEL_SELECTION = 88
const MODULE_EDITOR_COMMAND_COMPLETION = 89
const MODULE_EDITOR_COMMAND_COMPOSITION = 90
const MODULE_EDITOR_COMMAND_COPY = 91
const MODULE_EDITOR_COMMAND_COPY_LINE_DOWN = 92
const MODULE_EDITOR_COMMAND_COPY_LINE_UP = 93
const MODULE_EDITOR_COMMAND_CURSOR_CHARACTER_LEFT = 94
const MODULE_EDITOR_COMMAND_CURSOR_CHARACTER_RIGHT = 95
const MODULE_EDITOR_COMMAND_CURSOR_DOWN = 96
const MODULE_EDITOR_COMMAND_CURSOR_END = 97
const MODULE_EDITOR_COMMAND_CURSOR_HOME = 98
const MODULE_EDITOR_COMMAND_CURSOR_HORIZONTAL_LEFT = 99
const MODULE_EDITOR_COMMAND_CURSOR_HORIZONTAL_RIGHT = 100
const MODULE_EDITOR_COMMAND_CURSOR_SET = 101
const MODULE_EDITOR_COMMAND_CURSOR_UP = 102
const MODULE_EDITOR_COMMAND_CURSOR_VERTICAL = 103
const MODULE_EDITOR_COMMAND_CURSOR_WORD_LEFT = 103
const MODULE_EDITOR_COMMAND_CURSOR_WORD_PART_LEFT = 104
const MODULE_EDITOR_COMMAND_CURSOR_WORD_PART_RIGHT = 105
const MODULE_EDITOR_COMMAND_CUT = 106
const MODULE_EDITOR_COMMAND_DELETE_ALL_LEFT = 107
const MODULE_EDITOR_COMMAND_DELETE_ALL_RIGHT = 108
const MODULE_EDITOR_COMMAND_DELETE_CHARACTER_LEFT = 109
const MODULE_EDITOR_COMMAND_DELETE_CHARACTER_RIGHT = 110
const MODULE_EDITOR_COMMAND_DELETE_HORIZONTAL = 111
const MODULE_EDITOR_COMMAND_DELETE_HORIZONTAL_LEFT = 112
const MODULE_EDITOR_COMMAND_DELETE_HORIZONTAL_RIGHT = 113
const MODULE_EDITOR_COMMAND_DELETE_SELECTION = 114
const MODULE_EDITOR_COMMAND_DELETE_WORD_LEFT = 115
const MODULE_EDITOR_COMMAND_DELETE_WORD_PART_LEFT = 116
const MODULE_EDITOR_COMMAND_DELETE_WORD_PART_RIGHT = 117
const MODULE_EDITOR_COMMAND_DELETE_WORD_RIGHT = 118
const MODULE_EDITOR_COMMAND_DELTA = 119
const MODULE_EDITOR_COMMAND_FORMAT = 120
const MODULE_EDITOR_COMMAND_GET_POSITION_LEFT = 121
const MODULE_EDITOR_COMMAND_GET_POSITION_RIGHT = 122
const MODULE_EDITOR_COMMAND_GET_SELECTION_FROM_NATIVE_RANGE = 123
const MODULE_EDITOR_COMMAND_GO_TO_DEFINITION = 124
const MODULE_EDITOR_COMMAND_GO_TO_TYPE_DEFINITION = 125
const MODULE_EDITOR_COMMAND_HANDLE_CONTEXT_MENU = 126
const MODULE_EDITOR_COMMAND_HANDLE_DOUBLE_CLICK = 127
const MODULE_EDITOR_COMMAND_HANDLE_MOUSE_MOVE = 128
const MODULE_EDITOR_COMMAND_HANDLE_MOUSE_MOVE_WITH_ALT_KEY = 129
const MODULE_EDITOR_COMMAND_HANDLE_BEFORE_INPUT_FROM_CONTENT_EDITABLE = 130
const MODULE_EDITOR_COMMAND_HANDLE_NATIVE_SELECTION_CHANGE = 131
const MODULE_EDITOR_COMMAND_HANDLE_SCROLL_BAR_CLICK = 132
const MODULE_EDITOR_COMMAND_HANDLE_SCROLL_BAR_MOVE = 133
const MODULE_EDITOR_COMMAND_HANDLE_SINGLE_CLICK = 134
const MODULE_EDITOR_COMMAND_HANDLE_TAB = 135
const MODULE_EDITOR_COMMAND_HANDLE_TOUCH_END = 136
const MODULE_EDITOR_COMMAND_HANDLE_TOUCH_MOVE = 137
const MODULE_EDITOR_COMMAND_HANDLE_TOUCH_START = 138
const MODULE_EDITOR_COMMAND_HANDLE_TRIPLE_CLICK = 139
const MODULE_EDITOR_COMMAND_HANDLE_WHEEL = 140
const MODULE_EDITOR_COMMAND_INDENT = 141
const MODULE_EDITOR_COMMAND_INDENT_LESS = 142
const MODULE_EDITOR_COMMAND_INDENT_MORE = 143
const MODULE_EDITOR_COMMAND_INDENT_SELECTION = 144
const MODULE_EDITOR_COMMAND_INSERT_LINE_BREAK = 145
const MODULE_EDITOR_COMMAND_MOVE_LINE_DOWN = 146
const MODULE_EDITOR_COMMAND_MOVE_LINE_UP = 147
const MODULE_EDITOR_COMMAND_MOVE_RECTANGLE_SELECTION = 148
const MODULE_EDITOR_COMMAND_MOVE_RECTANGLE_SELECTION_PX = 149
const MODULE_EDITOR_COMMAND_MOVE_SELECTION = 150
const MODULE_EDITOR_COMMAND_MOVE_SELECTION_PX = 151
const MODULE_EDITOR_COMMAND_PASTE = 152
const MODULE_EDITOR_COMMAND_PASTE_TEXT = 153
const MODULE_EDITOR_COMMAND_POSITION = 154
const MODULE_EDITOR_COMMAND_REPLACE_RANGE = 155
const MODULE_EDITOR_COMMAND_REPLACE_SELECTION = 156
const MODULE_EDITOR_COMMAND_SAVE = 157
const MODULE_EDITOR_COMMAND_SELECT_ALL = 158
const MODULE_EDITOR_COMMAND_SELECT_ALL_OCCURRENCES = 159
const MODULE_EDITOR_COMMAND_SELECT_ALL_RIGHT = 160
const MODULE_EDITOR_COMMAND_SELECT_CHARACTER_LEFT = 161
const MODULE_EDITOR_COMMAND_SELECT_CHARACTER_RIGHT = 162
const MODULE_EDITOR_COMMAND_SELECT_HORIZONTAL_RIGHT = 163
const MODULE_EDITOR_COMMAND_SELECT_INSIDE_STRING = 164
const MODULE_EDITOR_COMMAND_SELECTION = 165
const MODULE_EDITOR_COMMAND_SELECT_LINE = 166
const MODULE_EDITOR_COMMAND_SELECT_NEXT_OCCURRENCE = 167
const MODULE_EDITOR_COMMAND_SELECT_PREVIOUS_OCCURRENCE = 168
const MODULE_EDITOR_COMMAND_SELECT_WORD = 169
const MODULE_EDITOR_COMMAND_SELECT_WORD_LEFT = 170
const MODULE_EDITOR_COMMAND_SELECT_WORD_RIGHT = 171
const MODULE_EDITOR_COMMAND_SET_DECORATIONS = 172
const MODULE_EDITOR_COMMAND_SET_DELTA_Y = 173
const MODULE_EDITOR_COMMAND_SET_LANGUAGE_ID = 174
const MODULE_EDITOR_COMMAND_SHOW_MESSAGE = 175
const MODULE_EDITOR_COMMAND_SNIPPET = 176
const MODULE_EDITOR_COMMAND_TAB_COMPLETION = 177
const MODULE_EDITOR_COMMAND_TOGGLE_BLOCK_COMMENT = 178
const MODULE_EDITOR_COMMAND_TOGGLE_COMMENT = 179
const MODULE_EDITOR_COMMAND_TOGGLE_LINE_COMMENT = 180
const MODULE_EDITOR_COMMAND_TYPE = 181
const MODULE_EDITOR_COMMAND_UNDO = 182
const MODULE_EDITOR_COMMAND_UNINDENT = 183
...
const loadModule = (moduleId) => {
  switch (moduleId) {
    ...
    case MODULE_EDITOR_COMMAND_APPLY_EDIT:
      return import('../EditorCommandApplyEdit/EditorCommandApplyEdit.ipc.js')
