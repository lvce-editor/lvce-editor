...
export const {
  Commands, Css, Events, Variables, create, dispose, getCommands, getComponentDom, getComponentState, getDisplayName, getKeyBindings, getMenus, getMouseActions,
  ...
  resizeWithDependencies, restoreState, saveState, setComponentState,
