...
export const __initialize__ = () => {
  ...
  Command.register('Editor.cursorsCharacterRight', Viewlet.wrapViewletCommand('EditorText', EditorCursorCharacterRight.editorCursorsCharacterRight))
  Command.register('Editor.cursorsDown', Viewlet.wrapViewletCommand('EditorText', EditorCursorDown.editorCursorsDown))
  Command.register('Editor.cursorSet', Viewlet.wrapViewletCommand('EditorText', EditorCursorSet.editorCursorSet))
  Command.register('Editor.cursorsHome', Viewlet.wrapViewletCommand('EditorText', EditorCursorHome.editorCursorsHome))
  Command.register('Editor.cursorsUp', Viewlet.wrapViewletCommand('EditorText', EditorCursorUp.editorCursorsUp))
  ...
  Command.register('Editor.open', Viewlet.wrapViewletCommand('EditorText', EditorCompletion.open))
  Command.register('Editor.openFromType', Viewlet.wrapViewletCommand('EditorText', EditorCompletion.openFromType))
