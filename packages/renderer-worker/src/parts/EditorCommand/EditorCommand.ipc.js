...
import * as EditorApplyEdit from '../EditorCommandApplyEdit/EditorCommandApplyEdit.js'
...
import * as EditorComposition from '../EditorCommandComposition/EditorCommandComposition.js'
import * as EditorCopy from '../EditorCommandCopy/EditorCommandCopy.js'
import * as EditorCopyLineDown from '../EditorCommandCopyLineDown/EditorCommandCopyLineDown.js'
import * as EditorCopyLineUp from '../EditorCommandCopyLineUp/EditorCommandCopyLineUp.js'
...
import * as EditorCursorDown from '../EditorCommandCursorDown/EditorCommandCursorDown.js'
...
import * as EditorCursorWordPartRight from '../EditorCursorWordPartRight/EditorCommandCursorWordPartRight.js/index.js'
import * as EditorCursorWordRight from '../EditorCommandCursorWordRight/EditorCommandCursorWordRight.js/index.js'
...
import * as EditorDeleteWordLeft from '../EditorCommandDeleteWordLeft/EditorCommandDeleteWordLeft.js/index.js'
import * as EditorDeleteWordPartLeft from '../EditorCommandDeleteWordPartLeft/EditorCommandDeleteWordPartLeft.js/index.js'
...
import * as EditorFormat from '../EditorCommandFormat/EditorCommandFormat.js'
...
import * as EditorHandleContextMenu from '../EditorCommandHandleContextMenu/EditorCommandHandleContextMenu.js'
...
import * as EditorHandleMouseMoveWithAltKey from '../EditorCommandHandleMouseMoveWithAltKey/EditorCommandHandleMouseMoveWithAltKey.js'
import * as EditorHandleBeforeInputFromContentEditable from '../EditorCommandHandleNativeBeforeInputFromContentEditable/EditorCommandHandleNativeBeforeInputFromContentEditable.js'
import * as EditorHandleNativeSelectionChange from '../EditorCommandHandleNativeSelectionChange/EditorCommandHandleNativeSelectionChange.js'
import * as EditorHandleScrollBarClick from '../EditorCommandHandleScrollBarClick/EditorCommandHandleScrollBarClick.js'
import * as EditorHandleScrollBarMove from '../EditorCommandHandleScrollBarMove/EditorCommandHandleScrollBarMove.js'
import * as EditorHandleSingleClick from './EditorCommandHandleSingleClick.js'
import * as EditorHandleTab from '../EditorCommandHandleTab/EditorCommandHandleTab.js/index.js'
...
import * as EditorCommandIndentLess from '../EditorCommandIndentLess/EditorCommandIndentLess.js'
import * as EditorCommandIndentMore from '../EditorCommandIndentMore/EditorCommandIndentMore.js'
import * as EditorInsertLineBreak from '../EditorCommandInsertLineBreak/EditorCommandInsertLineBreak.js'
import * as EditorMoveLineDown from '../EditorCommandMoveLineDown/EditorCommandMoveLineDown.js'
import * as EditorMoveLineUp from '../EditorCommandMoveLineUp/EditorCommandMoveLineUp.js'
...
import * as EditorMoveRectangleSelectionPx from '../EditorCommandMoveRectangleSelectionPx/EditorCommandMoveRectangleSelectionPx.js/index.js'
...
import * as EditorSave from '../EditorCommandSave/EditorCommandSave.js'
import * as EditorSelectAll from '../EditorCommandSelectAll/EditorCommandSelectAll.js'
import * as EditorSelectAllOccurrences from '../EditorCommandSelectAllOccurrences/EditorCommandSelectAllOccurrences.js'
...
import * as EditorSelectInsideString from '../EditorCommandSelectInsideString/EditorCommandSelectInsideString.js'
import * as EditorSelectLine from '../EditorCommandSelectLine/EditorCommandSelectLine.js'
import * as EditorSelectNextOccurrence from '../EditorCommandSelectNextOccurrence/EditorCommandSelectNextOccurrence.js'
import * as EditorSelectWord from '../EditorCommandSelectWord/EditorCommandSelectWord.js'
import * as EditorSelectWordLeft from '../EditorCommandSelectWordLeft/EditorCommandSelectWordLeft.js/index.js'
import * as EditorSelectWordRight from '../EditorCommandSelectWordRight/EditorCommandSelectWordRight.js'
import * as EditorSetDecorations from '../EditorCommandSetDecorations/EditorCommandSetDecorations.js'
import * as EditorSetDeltaY from '../EditorCommandSetDeltaY/EditorCommandSetDeltaY.js'
import * as EditorSetLanguageId from '../EditorCommandSetLanguageId/EditorCommandSetLanguageId.js'
...
import * as EditorUndo from '../EditorCommandUndo/EditorCommandUndo.js'
import * as EditorUnindent from '../EditorCommandUnIndent/EditorCommandUnindent.js'
import * as EditorBraceCompletion from '../EditorCommandBraceCompletion/EditorCommandBraceCompletion.js/index.js'
