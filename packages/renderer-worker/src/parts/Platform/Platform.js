...
export const isMobileOrTablet = () => {
  if (state.cachedIsMobileOrTablet === undefined) {
    state.cachedIsMobileOrTablet = state.isMobileOrTablet()
  }
  return state.cachedIsMobileOrTablet
}
