...
test('handleDrop - one file', async () => {
  ...
  expect(RendererProcess.invoke).toHaveBeenNthCalledWith(3, 'Viewlet.loadModule', 'EditorText')
  expect(RendererProcess.invoke).toHaveBeenNthCalledWith(4, 'Viewlet.sendMultiple', [['Viewlet.create', 'EditorText', 1], expect.anything()])
  expect(RendererProcess.invoke).toHaveBeenNthCalledWith(5, 'Viewlet.appendViewlet', 'Main', 1, true)
