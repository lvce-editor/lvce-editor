...
const ViewletEditorImageCopyImage = await import('../src/parts/ViewletEditorImage/ViewletEditorImageCopyImage.js')
...
test('copyImage', async () => {
  ...
  expect(Command.execute).toHaveBeenNthCalledWith(1, 'Ajax.getBlob', '/test/file.png')
