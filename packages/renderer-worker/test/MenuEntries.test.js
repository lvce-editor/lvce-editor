...
jest.unstable_mockModule('../src/parts/MenuEntriesModule/MenuEntriesModule.js', () => {
  return {
    load: jest.fn(() => {
...
const MenuEntriesModule = await import('../src/parts/MenuEntriesModule/MenuEntriesModule.js')

// TODO mock external modules for unit test

test.skip('getMenuEntries - activityBar', async () => {
  expect(await MenuEntries.getMenuEntries(MenuEntryId.ActivityBar)).toBeInstanceOf(Array)
})
