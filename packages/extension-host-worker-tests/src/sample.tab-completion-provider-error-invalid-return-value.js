...
const name = 'sample.tab-completion-provider-error-invalid-return-value'

test('sample.tab-completion-provider-error-invalid-return-value', async () => {
  // arrange
...
`
  ...
  await expect(overlayMessage).toHaveText(
    'Error: expected value to be of type number'
  )
})
