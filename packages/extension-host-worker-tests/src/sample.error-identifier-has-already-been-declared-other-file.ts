...
export const test = async ({ Extension, QuickPick, Locator, expect }) => {
  ...
  await expect(errorMessage).toHaveText(
    `Object: Failed to activate extension sample.error-identifier-has-already-been-declared-other-file: BabelParseError: Identifier 'x' has already been declared.`,
  )
