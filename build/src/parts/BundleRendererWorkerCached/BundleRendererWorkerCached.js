...
export const bundleRendererWorkerCached = async ({ commitHash, platform, assetDir, bundleIconTheme }) => {
  const rendererWorkerCachePath = await CachePaths.getRendererWorkerCachePath([platform, commitHash, bundleIconTheme])
