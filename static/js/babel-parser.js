...
- Did you mean \`import { "${importName}" as foo }\`?`,
  ...
  const tokTypes2 = generateExportedTokenTypes(tt);
...
var parse = lib.parse;
var parseExpression = lib.parseExpression;
var tokTypes = lib.tokTypes;
export {lib as __moduleExports, parse, parseExpression, tokTypes};
